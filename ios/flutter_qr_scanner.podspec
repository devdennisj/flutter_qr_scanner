Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'A Plugin for reading/scanning QR & Bar codes using the Google Mobile Vision API'
  s.description      = <<-DESC
A Plugin for reading/scanning QR & Bar codes using the Google Mobile Vision API.
                       DESC
